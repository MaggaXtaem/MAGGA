------------------------------------------------
-- This Source Was Developed By (MAGGA) @T71TT.--
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheMAGGA..'MAGGA:Channel:Join')}, },}}
...
if text == (Redis:get(TheMAGGA.."MAGGA:Name:Bot") or "الاسطوره") then
local NamesBot = (Redis:get(TheMAGGA.."MAGGA:Name:Bot") or "الاسطوره")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheMAGGA.."MAGGA:Name:Bot") or "الاسطوره")..
